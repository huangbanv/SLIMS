 ...
 * @author 张钧
 * @Description
 * @create 2022-06-06 16:50
 */
public class SADWorkerInterceptor implements HandlerInterceptor {
    @Override
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        if(RoleCheck.getUser().getRoleId().equals(RoleEnum.SAD_WORKER.getCode())){
